...
//importamos el compresor que va a comprimir el css que ya compilo webpack
...
//importamos el plugin para ordenar las carpetas para produccion se tiene que escribir asi como siendo un objeto
...
module.exports={//esto es un objeto de node
  ...
  //modo produccion y cambiamos la configuracion de packege json para que build se ejecute con esta config
  mode:'production',
  ...
  plugins:[//plugins con minuscula importante
    ...
    //usamos el plugin de ordenar carpetas 
    new CleanWebpackPlugin(),
  ],
  //agregamos configuraciones de optimizacion
  optimization:{
    minimize:true,//si va a minimizar
    minimizer:[//configuramos el minimazer que viene instalado ahora
      new CssMinimizerPlugin(),//agragamos el plugin para el soporte
      new TerserPlugin(),
    ]
  }
}